...
const MESSAGES = {
  ja: {
    ...
    permalinkCopied: "リンクをコピーしました",
    permalinkCopyFailed: "リンクをコピーできませんでした",
    ...
    backToHistory: "履歴に戻る",
    backToTitle: "トップへ戻る",
    invalidPermalinkTitle: "無効なリンクです",
    invalidPermalinkText: "指定された問題を開けませんでした。",
    localeJa: "日本語",
    localeEn: "English",
  },
  en: {
    ...
    retry: "Try Again",
    next: "Next Puzzle",
    sharedPuzzle: "Shared Puzzle",
    copyPermalink: "Copy Link",
    permalinkCopied: "Link copied",
    permalinkCopyFailed: "Could not copy link",
    ...
    invalidPermalinkTitle: "Invalid Link",
    invalidPermalinkText: "The requested puzzle could not be opened.",
    localeJa: "日本語",
    localeEn: "English",
  },
};
